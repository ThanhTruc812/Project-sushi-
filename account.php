    ...
    <div class="hero">
        <div class="form-box">
            ...
            <form action="xuli/login.php" class="input-group" id="dangnhap" method="POST">
                ...
                <button type="submit" class="submit-btn" name="dangnhap">Đăng nhập</button>
            ...
            <form action="xuli/register.php" class="input-group" id="dangky" method="POST">
                ...
                <input type="text" name="phone" class="input-field" pattern="^(0[234][0-9]{8}|1[89]00[0-9]{4})$" id="phone"  placeholder="Số điện thoại" required>
                ...
                <button type="submit" class="submit-btn" name="submit" value="submit">Đăng ký</button>
            </form>
        </div>
    </div>
    <script>
